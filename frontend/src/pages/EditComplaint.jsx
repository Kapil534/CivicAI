...
function EditComplaint() {
    ...
    useEffect(() => {
        ...
        const fetchComplaint = async () => {
            ...
            try {
                ...
                if (!response.ok) {
                    setError(
                        data.message || "Complaint fetch nahi ho paayi"
                    );
                    setLoading(false);
                    return;
                }
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                setError(
                    data.message || "Complaint update nahi ho paayi"
                );
                setSaving(false);
                return;
            }
                        ...
                        <div className="mb-7">
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="Dangerous Building">
                                        Dangerous Building
                                    </option>
                ...
                <div className="mt-6 bg-white border border-gray-100 rounded-2xl p-5 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1 leading-6">
                            Keep your complaint details accurate so authorities can understand and resolve the issue faster.
                        </p>
