    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-6">
        <div className="bg-white shadow-xl rounded-3xl border border-red-100 p-10 text-center max-w-md w-full">
          ...
          <p className="text-gray-500 mb-7">{error}</p>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <div>
              ...
              <p className="text-blue-100 mt-2">Complaint #{complaint.id}</p>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-7">
          ...
          <div className="space-y-7">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
              ...
              <div className={`border rounded-2xl p-4 ${statusStyle}`}>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 rounded-full bg-current"></div>

                  <span className="font-bold text-lg">{complaint.status}</span>
                </div>
              </div>
            </div>
            ...
            {/* Category */}
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
              <h2 className="text-lg font-bold text-gray-800 mb-5">Category</h2>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-gray-800">Complaint Submitted</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-gray-800">Resolved</p>
